...
export function Faq() {
  return (
    <section id="faq" className="border-t border-hairline bg-light-mesh relative overflow-hidden">
      ...
      <div className="shell relative z-10 py-16 sm:py-20 lg:py-36">
        <Reveal>
        ...
        <Reveal delay={0.16} className="mt-10 max-w-3xl sm:mt-14">
          <Accordion type="single" collapsible className="w-full">
            {faq.map((item, i) => (
              ...
              >
                <AccordionTrigger className="py-4 pr-2 text-left text-sm font-bold sm:py-5 sm:text-base text-[#201A57] hover:text-active hover:no-underline lg:text-lg transition-colors">
                  {item.question}
                </AccordionTrigger>
