...
const serviceCategories: Record<string, "hard" | "soft" | "mgmt"> = {
  ...
  "building-installations-asset-maintenance": "hard",
  "grounds-maintenance-indoor-plants": "soft",
  "programmed-replacement-lifecycle": "mgmt",
  "energy-utilities-management": "mgmt",
  "cleaning-services": "soft",
  "waste-management-services": "soft",
  "pest-control-services": "soft",
  "laundry-equipment-service": "soft",
  "security-equipment-maintenance": "hard",
  "vending-equipment-services": "hard",
...
export function Services() {
  ...
  return (
    <section id="services" className="border-t border-hairline bg-background py-16 sm:py-20 lg:py-36">
      <div className="shell">
        <Reveal>
        ...
        {/* Tab Filters */}
        <div className="-mx-1 mt-8 flex gap-2 overflow-x-auto border-b border-hairline px-1 pb-5 sm:mx-0 sm:mt-12 sm:flex-wrap sm:overflow-visible sm:px-0 sm:pb-6">
          {categories.map((cat) => {
            ...
            return (
              <button
                ...
                className={`relative shrink-0 px-4 py-2.5 text-xs font-semibold tracking-wide transition-all rounded-full sm:px-6 sm:py-3 sm:text-sm ${
                  isActive
        ...
        {/* Services Grid */}
        <motion.ul layout className="mt-8 grid gap-5 sm:mt-12 sm:grid-cols-2 sm:gap-6 lg:grid-cols-3">
...
export function Industries() {
  return (
    ...
    >
      ...
      />
      <div className="shell relative py-16 sm:py-20 lg:py-32">
        <Reveal>
        ...
        <div className="mt-10 grid gap-5 sm:mt-14 sm:gap-6 md:grid-cols-2 lg:grid-cols-4">
          {industries.map((ind, i) => (
            <Reveal key={ind.title} delay={0.06 * i}>
              <div className="h-full rounded-lg border border-hairline bg-[#121217] p-6 gold-glow sm:p-8 lg:p-10">
