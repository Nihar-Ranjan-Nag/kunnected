...
import { ArrowLeft, ArrowRight, Star, MapPin, Globe } from "lucide-react";
...
export function CaseStudy() {
  return (
    <section id="projects" className="relative overflow-hidden bg-background py-16 sm:py-20 lg:py-36">
      {/* Watermark background */}
      <div className="watermark-bg left-10 top-12 opacity-[0.015] pointer-events-none select-none">
        Khalifa University
      </div>

      <div className="shell relative z-10 grid gap-10 sm:gap-14 lg:grid-cols-2 lg:gap-24">
        ...
        <div>
          ...
          <div className="mt-10 grid gap-5 sm:mt-12 sm:grid-cols-2 sm:gap-6">
            <Reveal delay={0.2}>
              <div className="h-full rounded-lg border border-hairline bg-[#121217] p-5 gold-glow sm:p-6">
...
export function Testimonials() {
  ...
  return (
    <section className="border-t border-hairline bg-background">
      <div className="shell py-16 sm:py-20 lg:py-36">
        <Reveal>
        ...
        <div className="mt-10 grid gap-10 sm:mt-14 lg:grid-cols-[auto_1fr] lg:gap-20">
          <div className="relative min-h-0 lg:col-start-2 lg:min-h-[13rem]">
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <p className="display-md max-w-full text-white sm:max-w-[28ch]">
...
export function CtaBand() {
  return (
    ...
    >
      ...
      <div className="shell relative py-16 sm:py-20 lg:py-36">
        <Reveal>
        ...
        <div className="mt-10 grid gap-8 border-t border-hairline pt-8 sm:mt-14 sm:gap-10 sm:pt-10 md:grid-cols-2 lg:gap-14">
          <Reveal delay={0.14}>
            <div className="flex h-full flex-col justify-between rounded-xl bg-[#121217] p-6 sm:p-8 border border-active/40 shadow-[0_0_30px_rgba(63,128,207,0.15)] transition-all duration-300 hover:border-active hover:shadow-[0_0_40px_rgba(63,128,207,0.25)]">
              <div>
          ...
          <Reveal delay={0.18}>
            <div className="flex h-full flex-col justify-between rounded-xl bg-[#121217] p-6 sm:p-8 border border-hairline gold-glow">
              <div>
