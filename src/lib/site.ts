...
export const services = [
  {
    ...
    summary:
      "Integrated management and coordination of accommodation operations, service delivery, reporting, and performance.",
    imageKey: "control-room" as const,
  },
  {
    slug: "health-safety-management",
    title: "Health and Safety Management Services",
    summary:
      "Health, safety, compliance, and risk-management support across the student accommodation estate.",
    imageKey: "fire-safety" as const,
  },
  {
    slug: "helpdesk-service",
    title: "Helpdesk Service",
    summary:
      "A coordinated helpdesk for logging requests, tracking issues, escalating priorities, and supporting residents.",
    imageKey: "operations-management" as const,
  },
  {
    slug: "building-installations-asset-maintenance",
  ...
  },
  {
    ...
    title: "Programmed Replacement (Lifecycle)",
    summary:
      "Lifecycle planning and programmed replacement of assets to protect reliability and long-term performance.",
    imageKey: "preventive-maintenance" as const,
  },
  {
    slug: "energy-utilities-management",
